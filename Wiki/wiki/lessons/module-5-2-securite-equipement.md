---
title: "Équipement de Sécurité — L'Armement Obligatoire"
module: 5
...
Le déclenchement automatique utilise une **pastille hydrostatique** (soluable dans l'eau) ou un **déclencheur à goupille** pour percer la cartouche de CO2 au contact de l'eau. Fiable mais nécessite une inspection annuelle : vérifier que la pastille n'est pas blanche/dissoute (signe d'humidité) et que la cartouche est pleine et non rouillée.
...
> 1. Où sont les gilets (pour chaque taille)
> 2. Comment les mettre
> 3. Où est l'extincteur
> 4. Où est la balise de détresse
> 5. Le signal "tous dehors" (sifflet ou voix)
>

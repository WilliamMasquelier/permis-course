---
title: "Feux de Navigation et Signaux"
module: 1
...
>
> "C'est quoi ce truc avec le rouge et le vert ensemble ?" demande Christelle.
>
> William ouvre son carnet. C'est l'heure d'apprendre à lire la nuit.

## Pourquoi les feux ?

Les feux de navigation sont la langue de la mer la nuit. Ils permettent à tout marin d'identifier, à distance et dans l'obscurité, **le type de navire** qu'il observe, **la direction dans laquelle il se déplace**, et parfois **l'activité qu'il exerce** — pêche, remorquage, travaux. Sans cette lecture des feux, les règles de barre ne peuvent pas s'appliquer : vous ne savez pas à qui vous avez affaire.

L'obligation d'allumer les feux de navigation s'étend **du coucher au lever du soleil** et, pendant la journée, par **visibilité réduite** (brouillard, brume, pluie forte). En Méditerranée en été, le crépuscule tombe vite — il faut allumer les feux avant qu'il fasse vraiment noir, pas après.

Les feux de navigation permettent d'identifier, de nuit ou par visibilité réduite, **le type de navire**, **sa direction de déplacement** et parfois **son activité**. Un marin qui sait lire les feux peut appliquer les règles de barre sans voir la coque du bateau.
...
| Feu | Couleur | Secteur | Visible |
|-----|---------|---------|---------|
| Feu de côté bâbord | Rouge | 0°–112.5° (bâbord) | 2 milles |
| Feu de côté tribord | Vert | 0°–112.5° (tribord) | 2 milles |
| Feu de poupe | Blanc | 135° (secteur arrière) | 2 milles |
| Feu de tête de mât | Blanc | 225° (avant) | 3 milles |

**Comment lire la situation depuis ce que vous voyez :**
- Feu **vert seul** : vous voyez le côté tribord du navire — il traverse de gauche à droite devant vous.
- Feu **rouge seul** : vous voyez son côté bâbord — il traverse de droite à gauche.
- **Vert + rouge simultanément** : il vient droit sur vous ou presque — risque de collision potentiel.
- **Blanc de poupe seul** : il s'éloigne de vous.
- **Blanc de tête de mât + vert** (ou rouge) : bateau à moteur en route, vous voyez son avant de côté.

Voir [[concepts/feux-base]], [[concepts/feux-de-route]].

### Voilier sous voiles seules

Un voilier qui navigue **exclusivement à la voile**, moteur coupé, porte uniquement ses feux de côté (rouge bâbord, vert tribord) et son feu de poupe blanc. Il ne porte **pas de feu de tête de mât**. C'est cette absence de feu blanc à l'avant qui distingue un voilier sous voiles d'un bateau à moteur de nuit.

Les voiliers de moins de 20 mètres peuvent opter pour une **lanterne tricolore** en tête de mât qui combine les trois feux en un seul appareil — pratique pour l'économie d'énergie, visible de plus loin grâce à la hauteur.

Dès que le moteur est mis en marche, le voilier **allume le feu de tête de mât** et est désormais traité comme un bateau à moteur — avec les obligations de règles de barre correspondantes.

Voir [[concepts/feux-voilier]].

### Bateau à moteur

Un navire à propulsion mécanique porte obligatoirement un **feu blanc de tête de mât** couvrant 225° vers l'avant. Ce feu, combiné aux feux de côté, permet à tout observateur de déduire la direction de marche du navire quelle que soit la position depuis laquelle il l'observe.

Pour les navires de **plus de 50 mètres**, un **deuxième feu de tête de mât** est obligatoire, placé plus en arrière et plus haut que le premier. Depuis le côté, vous verrez deux feux blancs de hauteurs différentes — le plus haut est à l'arrière. Cette configuration vous permet de déduire non seulement la direction du navire mais aussi de quelle façon il se présente à vous (face, arrière, côté).

Le feu de mouillage (blanc tout-horizon) n'est **pas allumé pendant la route** — son absence confirme que le navire est bien en déplacement.

Voir [[concepts/feux-moteur]].

## Feux spéciaux — connaître par cœur

Certains navires exercent des activités spéciales qui limitent leur manœuvrabilité. Leurs feux distinctifs vous informent de leur situation pour que vous puissiez appliquer la bonne règle de barre.

| Situation | Feux caractéristiques |
|-----------|----------------------|
| Bateau au mouillage | Blanc tout-horizon (1 feu si < 50m) |
| Bateau échoué | 2 rouges verticaux + feux de mouillage |
| Bateau en pêche (chalut) | Vert sur rouge + feux de route si en déplacement |
| Bateau remorqué | Chaîne de remorquage > 200m → losange de jour |
...
Voir [[concepts/feux-mouillage]], [[concepts/feux-peche]], [[concepts/feux-remorquage]].

> [ATTENTION]
> **Le piège des feux de mouillage.** Un bateau au mouillage montre uniquement un feu blanc tout-horizon, sans les feux de côté. Si vous voyez rouge + vert + blanc, le bateau est en route. Si vous voyez seulement un blanc fixe et lent, il est ancré et vous devez le contourner.

## Signaux sonores

Ces signaux sont obligatoires en présence d'autres navires **en vue** les uns des autres. Ils ne se substituent pas aux manœuvres — ils les accompagnent ou les annoncent. Le signal de 5 sons brefs ou plus est le signal universel de danger et de doute : utilisez-le sans hésiter dès que vous ne comprenez pas les intentions d'un autre navire.

| Manœuvre | Signal | Situation |
|----------|--------|-----------|
| 1 coup bref | J'abats à tribord | Navires en vue |
| 2 coups brefs | J'abats à bâbord | Navires en vue |
| 3 coups brefs | Marche arrière | Navires en vue |
| 5+ coups brefs | Doute / danger | Toujours |
| 1 son long / 2 min | Brume (en route sous voile) | Visibilité réduite |

Pour les dépassements en chenal étroit, le navire rattrapant qui veut dépasser par tribord envoie **2 sons prolongés + 1 bref**. Par bâbord : **2 sons prolongés + 2 brefs**. L'accord du rattrapé se marque par **1 prolongé + 1 bref + 1 prolongé + 1 bref**.

Voir [[concepts/signaux-sonores-manoeuvre]], [[concepts/signaux-sonores-brume]], [[concepts/sons-manoeuvre]].

## Les marques de jour

Les marques de jour (*day shapes*) signalent en pleine lumière des situations qui de nuit seraient indiquées par des feux spéciaux. Elles sont noires, géométriques, et se hissent à la partie visible du gréement.

| Marque | Forme | Signification |
|--------|-------|---------------|
| Cône noir pointe en bas | Cône | Voilier naviguant sous moteur (même si voiles hissées) |
| Boule noire | Sphère | Mouillage |
| Losange noir | Losange | Remorquage avec remorque > 200m |
| Cylindre noir | Cylindre | Navire contraint par son tirant d'eau |
| 2 boules noires | 2 sphères | Navire non maître de sa route (NUC) |
| 3 boules verticales | 3 sphères | Navire échoué |

Le **cône black pointe en bas** est la marque la plus fréquente à l'examen et la plus ignorée en pratique. Si vous naviguez au moteur sur un voilier, hissez-le — il signale aux autres voiliers que vous n'avez pas de priorité.

> [EXEMPLE GOLFE]
> **Ce que vous voyez depuis Tersane Island ce soir :**
>
> - **Deux feux de côté (rouge + vert) avec blanc de poupe** : bateau en route, qui approche ou longe. S'il approche face à vous, vous voyez rouge ET vert simultanément → route de collision possible.
>
> - **Un feu blanc fixe, seul** : bateau au mouillage dans la baie. Calculez un écart de sécurité.
>

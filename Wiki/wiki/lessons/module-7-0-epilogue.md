---
title: "Épilogue — Retour à Göcek et Examen Blanc"
module: 7
module_title: "Épilogue et Examen Blanc"
session_in_module: 0
duration_min: 60
type: lesson
status: draft
...
> [SCENE]
> **Mercredi matin, 9h00. En route vers Göcek — dernier jour.**
>
> Le *Deniz Rüzgarı* avance sous voiles dans le vent doux du matin. Une semaine. Fethiye, Göcek, Tersane, Fethiye à nouveau, Ölüdeniz, Butterfly Valley, Hamam Koyu, Kızılada. Des centaines de milles parcourus. Des dizaines de situations vécues.
>
> William est à la barre. Il tient le cap sans regarder le compas toutes les cinq secondes. Il surveille naturellement le vent, les balises, le ciel. Christelle vient lui apporter son café. "Tu as l'air d'un marin," dit-elle.
>
...
| 2 | 2.2 | Carte marine | Ancré à Fethiye, le midi |
| 2 | 2.3 | Phares et amers | Quart de nuit à Fethiye |
| 3 | 3.1 | Cap et compas | Route vers Ölüdeniz |
| 3 | 3.2 | Marées | Conversation avec Emmanuel |
| 3 | 3.3 | Point estimé et GPS | Approche d'Ölüdeniz |
| 3 | 3.4 | Pilotage côtier | Route vers Butterfly Valley |
| 4 | 4.1 | Voile et allures | Retour sous Imbat |
| 4 | 4.2 | Manœuvres | Entrée en marina de Göcek |
| 4 | 4.3 | Mouillage | Hamam Koyu |
| 5 | 5.1 | Météo | Décision de traversée vers Kızılada |
| 5 | 5.2 | Équipement sécurité | Briefing gilets à Kızılada |
| 5 | 5.3 | Urgences (HAM, feu) | Exercice HAM off Yassıca |
| 5 | 5.4 | Brouillard, nuit | Brume nocturne à Kızılada |
| 6 | 6.1 | VHF, MAYDAY | Premier appel radio vers Fethiye |
| 6 | 6.2 | Documents, règlement | Douane de Fethiye |
| 7 | Épilogue | Examen blanc | Retour à Göcek |

## Les 10 réflexes d'un bon marin côtier

Ces dix habitudes ne viennent pas d'un manuel — elles viennent de skippers qui ont appris, parfois à leurs dépens, que la mer punit la négligence sans délai et récompense la méthode sans fanfare.

1. **Météo avant toute sortie** — Bulletins, baromètre, nuages, houle. Pas uniquement "est-ce qu'il fait beau" — mais "est-ce que ça va rester beau pendant le temps que je serai en mer ?" William a vécu ce dimanche matin à Hamam Koyu : trois hPa de chute, des cirrus, et une décision de partir tôt. Il avait la météo, il a décidé en connaissance de cause.

2. **Plan de navigation** — Route tracée, dangers identifiés, abris de secours. La route directe vers Butterfly Valley passait sur un banc à 1,4 m. Sans plan de navigation, William aurait découvert ça à 50 mètres du fond.

3. **Briefing sécurité** — Gilets, extincteur, balise, signal d'alarme. William l'a fait le premier matin à Kızılada, cinq jours après le départ. Christelle avait mis le gilet dans un coffre et ne savait pas comment l'enfiler. Une minute de briefing au départ évite des heures de panique en urgence.

4. **Veille permanente** — La Règle 5 du RIPAM n'est pas une formalité. Sur l'eau, les incidents surviennent rapidement. Un bateau à 15 nœuds parcourt 100 mètres en 13 secondes. Regardez autour de vous, toutes les 10 minutes minimum. Ne naviguez pas en regardant votre téléphone.

5. **Journal de bord** — Notez la position, le cap, la vitesse, l'heure à chaque changement. Si le GPS tombe en panne, votre journal vous permet de reconstruire votre point estimé depuis la dernière position connue. Si un accident survient, votre journal est la première pièce du dossier.

6. **Confirmation de position régulière** — GPS + relèvements croisés. Le GPS dit que vous êtes à un endroit. Un relèvement sur deux amers dit la même chose, ou pas. Si les deux concordent : bien. Si ils divergent : quelque chose cloche — croyez l'observateur, pas l'électronique seule.

7. **Conservatisme** — En cas de doute sur une route, un fond, une météo, une manœuvre : prenez la décision la plus sûre, pas la plus rapide. Le détour de 2 NM vers Butterfly Valley était la bonne décision. Partir plus tôt vers Kızılada était la bonne décision. Le conservatisme ne gâche pas le voyage — il le rend possible.

8. **Communication** — Canal 16 en veille permanente, appeler avant d'avoir besoin. Signaler votre départ à la capitainerie, annoncer votre ETA au port d'arrivée. Si vous disparaissez, quelqu'un doit savoir que vous deviez arriver quelque part.
...
Cette session se termine par un examen blanc complet — 40 questions, dans les mêmes proportions thématiques que l'examen officiel, organisées autour du voyage dans le golfe de Fethiye. C'est votre premier test en conditions réelles avant l'examen officiel.

**Comment aborder cet examen blanc :**
- Installez-vous au calme, sans interruptions, pendant 1h45 maximum (durée officielle)
- Répondez à toutes les questions sans consultation de vos notes dans un premier temps
- Notez les questions sur lesquelles vous hésitez — revenez-y en fin d'examen
- À la fin : corrigez, identifiez les thèmes où vous avez fait des erreurs, revenez aux sessions correspondantes
...
- **Règles de barre et feux** : 10–12 questions
- **Navigation** : 6–8 questions
- **Sécurité et météo** : 7–9 questions
- **Radio et réglementation** : 4–6 questions

Voir [[Wiki/wiki/questions/]] pour la banque de questions complète.

> [SAVOIR FAIRE]
> **Stratégie d'examen :**
>
> 1. Lisez chaque question deux fois — les pièges sont souvent dans les mots "toujours", "jamais", "uniquement".
> 2. Eliminez les réponses clairement incorrectes avant de choisir.
> 3. Si vous hésitez entre deux réponses, notez la question et revenez-y en fin d'examen.
...
>
> L'ancre remonte. Les amarres sont larguées. Le *Deniz Rüzgarı* glisse vers son poste au ponton F.
>
...
*Fin du cours. L'examen blanc de 40 questions est accessible via le menu `/permis-exam`.*

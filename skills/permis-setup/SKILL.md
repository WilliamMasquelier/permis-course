...
Run these shell checks (PLUGIN_ROOT=`${CLAUDE_SKILL_DIR}/../..`):

    python3 --version 2>&1
    ls "${CLAUDE_SKILL_DIR}/../../.venv/bin/python" 2>/dev/null || echo MISSING
    cd "${CLAUDE_SKILL_DIR}/../.." && uv run python -c "import jinja2, markdown_it, fsrs; print('OK')" 2>&1

...
files = [
    "raw/course-2/2-regle_de_barre-RECTO.pdf",
    "raw/course-2/2-regle_de_barre-VERSO.pdf",
    "raw/course-2/3-Les_signaux-RECTO.pdf",
    "raw/course-2/3-Les signaux-VERSO.pdf"
]
